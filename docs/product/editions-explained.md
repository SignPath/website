...
SignPath supports signing Docker container images and tags using Docker Content Trust (DCT). See [Signing Container Images](/documentation/signing-containers) for details.
