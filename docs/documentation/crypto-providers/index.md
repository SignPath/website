...
| `ProjectSlug`                           | `SIGNPATH_PROJECT_SLUG`                                | (optional)       | The project slug. Used for filtering available certificates/keys. (macOS and Cryptoki)
| `SigningPolicySlug`                     | `SIGNPATH_SIGNING_POLICY_SLUG`                         | (optional)       | The signing policy slug. Used for filtering available certificates/keys. (macOS and Cryptoki)
